...
@WebServlet("/GetRiunioniIndette")
public class GetRiunioniIndette extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private Connection connection;
       
    public GetRiunioniIndette() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Riunione> riunioniIndette = new ArrayList<Riunione>();
		
		try {
			riunioniIndette = uDAO.trovaMieRiunioni(utente.getId());	//recupero le riunioni a l'utente è stato invitato
		...
		Gson gson = new Gson();
		String json = gson.toJson(riunioniIndette);	//uso gson per serializzare
